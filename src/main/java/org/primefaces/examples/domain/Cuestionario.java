...
public class Cuestionario implements Serializable {
    ...
    public Cuestionario(String name) {
        this.name = name;
    }

    public Cuestionario(String name, int number, String photo) {
        this.name = name;
        this.number = number;
        this.photo = photo;
    }

    public Cuestionario(String name, int number, String photo, String position) {
        this.name = name;
        this.number = number;
        this.photo = photo;
    ...
    public Cuestionario(String name, int number) {
        this.name = name;
        this.number = number;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Cuestionario)) {
            return false;
        }

        return ((Cuestionario) obj).getNumber() == this.number;
    }
