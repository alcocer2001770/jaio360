...
public class Respuesta implements Serializable {
    ...
    public Respuesta(String name) {
        this.name = name;
    }

    public Respuesta(String name, int number, String photo) {
        this.name = name;
        this.number = number;
        this.photo = photo;
    }

    public Respuesta(String name, int number, String photo, String position) {
        this.name = name;
        this.number = number;
        this.photo = photo;
    ...
    public Respuesta(String name, int number) {
        this.name = name;
        this.number = number;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ((Respuesta) obj).getNumber() == this.number;
    }
